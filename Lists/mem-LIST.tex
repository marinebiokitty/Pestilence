...
%Outsider (Dr. Filin) last minute sanity recovery  mechanic; Rebel starts with it
  ...
  \NEW{MemFold}{\mInstructions}{
  	\s\MYname	{Open if the doctor seems to have lost their mind and you're still in love with them}
  	\s\MYtext	{This is not the \cOutsider{} you knew and loved. Seeing \cOutsider{\them} like this is almost as bad as losing \cOutsider{\them} again. You don't care if \cOutsider{} hates you as long as \cOutsider{\they} has \cOutsider{\their} mind again. You wonder if the truth would help: truth about the plague, about the resurrection, about your love for \cOutsider{} and why you did what you did. Yet you worry as well. \cOutsider{} needs the truth, but can \cOutsider{\they} handle it in such a fragile state? Will the truth bring \cOutsider{\them} back or will you just watch as \cOutsider{\they} voids your sacrifice and shoots \cOutsider{\themself} in the head?

Give the other memfold in the envelope to \cOutsider{} after you've told \cOutsider{\them} the whole truth about the plague. You may choose not to do so. If you've told the entire truth to \cOutsider{} already, give \cOutsider{\them} the memfold along with an optional declaration of love.}
  }
...
Your belief score is stabilized at 11, even if you have already reached 12. Magic can no longer raise your belief score or break your sanity. However, you are still a bit shaken and plagued by sporadic visions of your death. Roleplay and react accordingly.
