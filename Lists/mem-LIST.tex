...
\NEW{MemFold}{\mTest}{
  ...
  \NEW{MemFold}{\mKappa}{
  	\s\MYname	{Kappa packet. Open if directed to do so.}
  	\s\MYtext	{You reel back in horror. Your parents are in two of the hundreds of stasis pods, brain-dead and unresponsive.}
  }
