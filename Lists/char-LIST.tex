...
\NEW{PC}{\cApprentice}{
	...
	\s\MYwhites	{}
	\s\MYmems{\mPowderRecognize{}\mFakeRecognize{}}	
	\s\MYcr{2}
...
\NEW{PC}{\cOutsider}{
	...
	\s\MYmems	{\mPowderRecognize{}\mFakeRecognize{}\mBelief{}}
	\s\MYwhites	{}
...
\NEW{PC}{\cShaman}{
	...
	\s\MYitems	{\multi{3}{\iBlood{}}\multi{3}{\iCoins{}}\iBoneDagger{}}
	\s\MYmems	{}
	\s\MYwhites	{}
