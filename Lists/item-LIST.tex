...
\NEW{Item}{\iVidcam}{
  ...
  \s\MYtext	{
  	...
  	This video camera lets you record people doing things. It can store up to 3 recordings at a time. If it is full, recordings must be erased before new ones can be made.
	
  	\begin{enum}[Directions]
      \item With one hand, make a circle and hold it up to your eye, as if looking through a telescope. Tell anyone who looks at you that you are holding up a video camera.
      \item Look through the circle at someone doing something for a silent, interruptible five count. The activity must be recorded for the entire five count.
      \item Out of game, ask them to show you the front of the ability card for what they were doing.
      \item Write the character name(s) and the ability number on a blank item card.
    \end{enum}
	}
  }
