...
%Environmental
 ...
 \NEW{ItemEnvelope}{\iNotes}{
	  ...
	  \s\MYnumber	{0000}
	  \s\MYtext	{Open if you have a belief score, reagrdless of its current value}
	  ...
	  The handwriting, though. It seems familiar. Is this \cRebel{}'s research? Should you tell \cRebel{\them} about this? What if \cRebel{\they} refuses to let you use this? Will \cRebel{\they} think you stole from \cRebel{\them}?}
  }
