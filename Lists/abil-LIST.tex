...
\NEW{Abil}{\aRitualSacrifice}{
    ...
    \s\MYtext	{Kill targeted character in order to appease the earth. To activate the ability, three player characters must form a triangle around the victim for 5 uninterrupted minutes. Not all characters in triangle need to have this ability. Victim is trapped within the triangle as long as no part of the triangle steps away or gets attacked. Victim does not need to be conscious for the ritual to start. At the end of 5 minutes, ask the victim if they are willing to give themselves to the earth. Regardless of the answer, the victim is sacrificed. Interruption resets timer.}
    \s\MYeffect	{You are being sacrificed. You cannot leave the triangle unless this ability is interrupted by outside forces}
	\s\MYnumber {9221}    
}
...
\NEW{Abil}{\aTrueSight}{
	\s\MYname	{True Sight}
	\s\MYtext	{You can see but not hear characters in yellow headbands}
...
\NEW{Abil}{\aImmunity}{
	\s\MYname	{Immunity}
	\s\MYtext	{You are not affected by the plague. You may choose to either display symptoms (have a sticker on your name badge) or not. Cures cannot take away your ability to spread the plague. Do not show this card to others}
...
\NEW{Abil}{\aMakePotion}{
	\s\MYname	{MakePotion}
	\s\MYtext	{You know how to reproduce potion 0012. Gather 2 vials of blood and a copper coin. The rest of the ingredients are easily accessible to you. Once you have the ingredients, you may destroy them and get item 0012 from Envelope X}
...
\NEW{Abil}{\aReturnToEarth}{
	...
	\s\MYeffect	{You see a figure wreathed in blue flames, chanting.}
	\s\MYnumber {7173}
}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%Money-related abilities

%Con, start
\NEW{Abil}{\aBribery}{
	\s\MYname	{Bribery}
	\s\MYtext	{If the army arrives at the shelter and you have at least 15 coins, you can leave the shelter regardless of infection. Hopefully, city hospitals and real antibiotics are better at managing this disease.}
	\s\MYeffect	{I give the army doctor a bag of coins and a radiant smile.}
	\s\MYnumber {7173}
}
...
\NEW{Abil}{\aWound}{
    \s\MYname	{Wound}
    \s\MYtext	{You can wound someone as an attack. This requires a weapon. Say ``\MYname'' and
    		your CR.}
...
\NEW{Abil}{\aKillingBlow}{
    ...
    \s\MYtext	{If you have a weapon, you can perform a killing blow on someone else after an audible, interruptible 10-count. The target must be helpless (unconscious, wounded, or restrained). All NPC targets are considered helpless.}
