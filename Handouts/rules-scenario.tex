...
\paragraph{Game Spaces:} We will be playing in several rooms in the second and third floors of building 200 (History Corner), as well as most of the hallways therein. Please meet in {\bf -203} at 1:30 pm. The GMs will place you where you need to be for game start. The elevator is the airlock between ships, players are not allowed to hide in the elevator. If the elevator is being used by None Players and thus not usable, then the main stair case may be used only to transfer between levels. No game actions may take place on the main staircase (Doing so may be quite hazardous to your out of game health). Other than this case the three staircases are not considered part of game space and may not be used.
...
Killing Blows require a 10 count. Do not require a weapon. They do require that the victim be helpless such as knocked out or restrained.
...
\paragraph{Teachable Mechanics:} If you have a mechanic that can be taught to another character and choose to do so, tell the player to go to a GM to get a copy of the relevant green sheet.

\paragraph{Notes about Stuff that is illegal:} The following actions are considered to be illegal. Hacking. Sabotage. Murder (Murder being the act of using killing blow on someone)
