...
\documentclass[sheet]{Pestilence}
...
\paragraph{Game Times:} Game runs from 2pm to 4:30pm on {\bf Saturday, January 27th}, in the second and third floors of building 200 (History corner). Surviving PCs are expected to be in-game for the entirety.  Game may end early.  Cleanup and Wrapup will immediately follow the end of
game. Please plan to arrive by {\bf 1:30 pm} to get situated  before the game starts. {\bf If you will be late, you must CALL the GMs and let us know. Mashbayar 650-656-7102} 

\paragraph{Game Spaces:} We will be playing in several rooms in the second and third floors of building 200 (History Corner), as well as most of the hallways therein. Please meet in {\bf Room 203} at 1:30 pm. The GMs will place you where you need to be for game start. %The elevator is the airlock between ships; players are not allowed to hide in the elevator. If the elevator is being used by Non Players and thus not usable, then the main staircase may be used only to transfer between levels. No game actions may take place on the main staircase (as doing so may be quite hazardous to your out-of-game health). Other than this case, the three staircases are not considered part of game space and may not be used.
...
when you hear or read it in-game.  If it's a symbol, open when you see
that symbol.  Do not take game action based on an unopened trigger.  Do
...
other characters, you may be able to return as a ghost. 

\subsection{Weapons}

Weapons are represented only by item cards in this game (no phys reps).
Weapons grant a CR bonus; item that do not give a CR bonus are not viable weapons for combat.  
To use a weapon, you must have it in your hand and unobstructed.  Display it in an obvious manner.  You
cannot hold more than one weapon in a hand.  You may only use one
melee weapon at a time.

\subsection{Killing Blow}

Killing Blows require an audible, interruptible 10-count. They
require a weapon. They require that the victim be helpless, such as
knocked out or restrained.
...
Wound attacks require a weapon. Restrain attacks require rope (which is freely available). Knock Out attacks do not require any item.
...
\begin{enumerate}
  ...
  \item A yellow headband represents a ghost or a spirit. You cannot see or interact with them unless you have the relevant ability 
  \item A red headband represents someone on fire
...
\section{Pestilence Specific Changes}
...
\subsection{Blood}
All characters have 3 portions of blood in their body at the start of game unless stated otherwise. Blood can only be extracted by those with the ability to do so. Mark extracted blood with a check. Once extracted and marked, blood is then transferable. However, it can't be put back inside the body again. If you have no blood in your body, you die. 

Blood from a corpse is useless for all purposes. If you are killed, dispose of all non-extracted blood you had.

\subsection{NPCs}
The elder's house shelters many lethargic NPC townsfolk, represented by signs on the wall. They are able to be infected or killed, but they will neither give blood nor participate in any experiment. More information on NPC mechanics can be found in the Townsfolk green sheet.   
%
\subsection{Stickers}
Stickers represent infection. If infected, place a sticker on your name badge. More information on infection mechanics can be found in the Infection green sheet. 

\subsection{The Army and Endgame}
Five minutes before the end of the game, the army will arrive to evacuate survivors. All uninfected PCs will be allowed to leave the shelter during this time, barring special circumstances. At the end of the game, all PCs still in the shelter will be killed as the army razes the infected town.
