...
The Veran ship \emph{TIS Chivalry} is wrapping up a long mission of collecting “cargo” in human space. The eccentric officers have assembled quite a unique crew over the past couple of thousand years. They are on their way home to make a few very lucrative deliveries. They had hoped to slip through Frith space without being detected, but as the Peacekeeper-class ship \emph{HMS Anodyne} approaches for a routine border inspection, it seems they will not be so lucky. The Captain and crew have only a few hours to resolve the situation with the cops and be on their way if they are to make their rendezvous, but not everyone may want the same resolution.
...
{\bf The Ver are immune to combat mechanics (including waylay, mentioned later on), unless weakened by UV Exposure or Holy Water. These two conditions require in-game abilities or items to inflict, and can only be inflicted if within one ZOC of the Ver. This makes them susceptible to combat mechanics for 15 minutes, while also boosting their CR by 2 for the same 15 minutes.}
...
\paragraph{Illegal:} You know that the following actions are considered to be illegal in Frith space: Hacking, sabotage, murder (the act of using Killing Blow on someone), slavery.
