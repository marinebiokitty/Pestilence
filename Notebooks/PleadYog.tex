...
\begin{page}{Sixth}
	...
	You wish to beseech Yug Sothoth for a path away from this place. While the preparation may be conducted at any time, the passage may only be opened at time 3 hrs 45 min into game, and also only if the ritual leader states the final activation chant listed on the ability card.
	...
	Destroy the item cards involved then get one \aOpenWay{} from the X Packet
